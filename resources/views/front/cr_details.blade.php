				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
                        <div class="pagination-area">
                            ...
                            <a href="bank_account_details.html" class="page-numbers">Account Details</a><i class="bx bx-chevron-right"></i>
							<a href="cr_details.html" class="page-numbers current">Documents</a>
						...
						<form method="post">
							...
							<h6>Upload:</h6>
								<div class="col-12">
								  ...
								  <p>Copy of Commercial Registry:</p>
