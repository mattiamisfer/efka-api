                ...
                <div class="widget-1 card no-border bg-complete no-margin widget-loader-circle-lg">
                  <div class="card-header top-right ">
                    <div class="card-controls">
                      <ul>
                        <li><a data-toggle="refresh" class="text-black card-refresh" href="#"><i
                      ...
                      <div class="row stock-rates m-t-15">
                        <div class="company col-4">
                          <div>
                            <p class="font-montserrat text-success no-margin fs-16">
                              ...
                              <span class="text-white font-arial fs-12 hint-text m-l-5">546.45</span>
                            </p>
                            <p class="text-white bold no-margin fs-11 font-montserrat lh-normal">
                              AAPL
                            </p>
                          </div>
                        </div>
                        <div class="company col-4">
                          <div>
                            <p class="font-montserrat text-danger no-margin fs-16">
                              ...
                              <span class="text-white font-arial fs-12 hint-text m-l-5">345.34</span>
                            </p>
                            <p class="text-white bold no-margin fs-11 font-montserrat lh-normal">
                              YAHW
                            </p>
                        ...
                        <div class="company col-4">
                          <div class="pull-right">
                            <p class="font-montserrat text-success no-margin fs-16">
                              <i class="fa fa-caret-up"></i> +0.95%
                              <span class="text-white font-arial fs-12 hint-text m-l-5">278.87</span>
                            </p>
                            <p class="text-white bold no-margin fs-11 font-montserrat lh-normal">
                              PAGES
                            </p>
                ...
                <div class="widget-4 card no-border no-margin widget-loader-bar">
                  <div class="container-sm-height full-height d-flex flex-column">
                    <div class="card-header ">
                      <div class="text-black card-title hint-text">
                      ...
                      <div class="card-controls">
                        <ul>
                          <li><a href="#" class="text-black card-refresh" data-toggle="refresh"><i
                    ...
                    <div class="mt-auto widget-4-chart line-chart" data-line-color="success" data-area-color="success-light" data-y-grid="false" data-points="false" data-stroke-width="2">
                      <svg></svg>
                    </div>
                  </div>
                </div>
                ...
                <div class="widget-5 card no-border widget-loader-bar">
                  ...
                  <div class="container-xs-height full-height">
                    <div class="row row-xs-height">
                      <div class="relative col-xs-5 col-xs-height col-middle">
                      ...
                      <div class="relative col-xs-7 col-xs-height col-bottom widget-5-chart-container">
                ...
                <div class="widget-2 card no-border bg-primary widget widget-loader-circle-lg no-margin">
                  ...
                  <div class="card-body">
                    <div class="pull-bottom bottom-left bottom-right padding-25">
                      ...
                      <p class="text-white hint-text d-none d-lg-block d-xl-block">Learn More at Project Pages</p>
                    </div>
                  </div>
                </div>
                <!-- END WIDGET -->
                    ...
                    <div class="metro live-tile" data-mode="carousel" data-start-now="true" data-delay="3000">
                      <div class="slide-front tiles slide active">
                        <div class="padding-30">
                          ...
                          <div class="pull-bottom p-b-30">
                            ...
                            <h3 class="text-white no-margin p-b-10">Carefully
                          <br>designed for a
                          <br>great
                      ...
                      <div class="slide-back tiles">
                        <div class="padding-30">
                          ...
                          <div class="pull-bottom p-b-30">
                            <p class="p-t-10 fs-12 p-b-5 hint-text">21 Jan</p>
                            <h3 class="text-white no-margin p-b-10">A whole new
                          <br>
                      ...
                      <div class="slide-front tiles slide active">
                        <div class="padding-30">
                          <div class="pull-bottom p-b-30 bottom-right bottom-left p-l-30 p-r-30">
                            ...
                            <p class="text-black no-margin hint-text">NASDAQ : AAPL - NOV 01 8:40 AM ET</p>
                            <h3 class="text-white semi-bold"><i
                              class="text-white fa fa-sort-up small"></i> 0.15 (0.13%)
                      </h3>
                        ...
                        <div class="container-sm-height full-height">
                          <div class="row-sm-height">
                            <div class="col-sm-height padding-25">
                              <p class="text-black hint-text">Pre-market: 116.850.50 (0.43%)
                              </p>
                              <p class="text-black p-t-10">AAPL - Apple inc.</p>
                              <div class="p-t-10">
                                <p class="inline hint-text">+0.42% <span class="m-l-20">217.51</span>
                                </p>
                                <div class="inline"><i class="text-white fa fa-sort-up small fs-16 col-bottom"></i>
                                </div>
                              </div>
                              <p class="text-black p-t-10">GOOG - Google inc.</p>
                              <div class="p-t-10">
                                <p class="inline hint-text">+0.22% <span class="m-l-20">-2.28</span>
                                </p>
                                <div class="inline"><i class="text-white fa fa-sort-down small fs-16 col-top"></i>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="row-sm-height">
                            <div class="relative col-sm-height">
        ...
        <div class="col-lg-4 col-xl-3 col-xlg-2 ">
            ...
            <div class="col-md-12 m-b-10">
              ...
              <div class="widget-8 card no-border bg-success no-margin widget-loader-bar">
                <div class="container-xs-height full-height">
                    ...
                    <div class="col-xs-height col-top">
                      <div class="card-header top-left top-right">
                        ...
                        <div class="card-controls">
                          <ul>
                            <li>
                              <a data-toggle="refresh" class="text-black card-refresh" href="#"><i
                                      class="card-icon card-icon-refresh"></i></a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div class="row-xs-height ">
                    <div class="relative col-xs-height col-top">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="p-l-20">
                            <h3 class="text-white no-margin p-b-5">$14,000</h3>
            ...
            <div class="col-md-12 m-b-10">
              ...
              <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
                <div class="full-height d-flex flex-column">
                  <div class="card-header ">
                    <div class="text-black card-title">
                      <span class="font-montserrat fs-11 all-caps">Weekly Sales <i
                  class="fa fa-chevron-right"></i>
                              </span>
                    </div>
                  ...
                  <div class="p-l-20">
                    <h3 class="text-white no-margin p-b-5">$23,000</h3>
                    <a href="#" class="text-white btn-circle-arrow"><i
                  class="pg-arrow_minimize"></i>
          </a>
                    <span class="text-white small hint-text">65% lower than last month</span>
                  </div>
                  <div class="mt-auto">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="bg-white widget-10 card no-border no-margin widget-loader-bar">
                <div class="card-header top-left top-right ">
                  <div class="text-black card-title hint-text">
                    ...
                    <div class="card-header pull-up top-right ">
                      <div class="card-controls">
                        <ul>
                          ...
                          <li>
                            <a data-toggle="refresh" class="text-black card-refresh" href="#"><i class="card-icon card-icon-refresh"></i></a>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-xlg-8 col-lg-12">
                      ...
                      <span class="text-danger fs-12">-318.24</span>
                        ...
                        <div class="text-center nvd3-line line-chart" data-x-grid="false">
                          <svg></svg>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="company-stat-boxes">
                        <div data-index="0" class="company-stat-box m-t-15 active padding-20 bg-master-lightest">
                          ...
                          <div class="m-t-10">
                            ...
                            <div class="pull-right">
                              <p class="inline small hint-text no-margin">37.73</p>
                              <span class="inline label label-important p-t-5 m-l-5 p-b-5 fs-12">+ 0.09</span>
                            </div>
                            <div class="clearfix"></div>
                          </div>
                        </div>
                        <div data-index="1" class="company-stat-box m-t-15 padding-20 bg-master-lightest">
                          ...
                          <div class="m-t-10">
                            ...
                            <div class="pull-right">
                              <p class="inline small hint-text no-margin">37.73</p>
                              <span class="inline label label-success p-t-5 m-l-5 p-b-5 fs-12">+ 0.09</span>
                            </div>
                            <div class="clearfix"></div>
                          </div>
                        </div>
          ...
          <div class="widget-15 card card-condensed no-margin no-border widget-loader-circle">
            ...
            <div class="card-body no-padding">
              ...
              <div class="p-t-20 p-l-20 p-r-20 p-b-30">
                <div class="row">
                  <div class="col-md-9">
                    <p class="text-black fs-16">Apple’s Motivation - Innovation
        ...
        <div class="col-lg-8 m-b-10">
          ...
          <div class="widget-13 card no-border no-margin widget-loader-circle">
            <div class="card-header pull-up top-right ">
              <div class="card-controls">
                <ul>
                  <li><a href="#" class="text-black card-refresh" data-toggle="refresh"><i class="card-icon card-icon-refresh"></i></a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="container-sm-height no-overflow">
              <div class="row row-sm-height">
                ...
                <div class="relative col-sm-7 col-lg-8 col-xlg-9 col-sm-height col-top no-padding">
        ...
        <div class="col-lg-4 m-b-10">
          ...
          <div class="widget-14 card no-border no-margin widget-loader-circle">
            <div class="container-xs-height full-height">
                  ...
                  <div class="p-l-20 p-r-20">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 visible-xlg">
                        <div class="text-black bg-transparent widget-14-chart-legend no-padding pull-right"></div>
                        <div class="clearfix"></div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row-xs-height">
                <div class="relative col-xs-height bg-master-lightest">
        ...
        <div class="col-lg-4 visible-lg hidden-xlg sm-m-b-10 md-m-b-10">
          ...
          <span class="text-success">+60.223%</span>
            ...
            <div class="p-t-10 p-l-20 p-r-20 p-b-30">
              <div class="row">
                <div class="col-md-9">
                  <p class="text-black fs-16">Apple’s Motivation - Innovation distinguishes between A leader and a follower.
                  </p>
        ...
        <div class="col-xlg-2 visible-xlg ">
          ...
          <div class="widget-18 card no-border no-margin ">
            ...
            <div class="relative">
              ...
              <div class="bg-black widget-18-post no-overflow">
              </div>
            </div>
            <div class="padding-15">
              ...
              <div class="card no-border no-margin">
                ...
                <div class="relative">
                  ...
                  <div class="widget-19-post no-overflow">
                    <img src="assets/img/social-post-image.png" class="relative block center-margin" alt="Post">
                  </div>
                </div>
                <div class="padding-15">
                  <div class="hint-text pull-left">few seconds ago</div>
        ...
        <div class="col-md-8 col-lg-5 col-xlg-5">
            ...
            <div class="card-header ">
              ...
              <div class="card-controls">
                <ul>
                  ...
                  <li>
                    <a data-toggle="refresh" class="text-black card-refresh" href="#">
          ...
          <span class="semi-bold">rainy</span>
                    ...
                    <div class="row m-t-10 timeslot">
                      <div class="text-center col-2 p-t-10">
                  ...
                  <div class="col-xlg-6 visible-xlg">
                    <div class="row">
                      <div class="text-center forecast-day col-lg-6 m-t-10 ">
                      ...
                      <div class="text-center col-lg-6 m-t-10 ">
                        <div class="bg-master-lightest p-b-10 p-t-10">
