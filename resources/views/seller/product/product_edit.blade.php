...
<div class="content ">
    ...
    <div class=" container-fluid container-fixed-lg">
      <div class="row">
        ...
        <div class="col-lg-12">
            <form class="" role="form"  action="{{route('product.product.update',$products->id)}}" method="POST" enctype="multipart/form-data" >
              @csrf
                            ...
                            <div class="tab-pane active" id="tab2english">
                                <div class="row column-seperation">
                                    <div class="form-group form-group-default required ">
                                        ...
                                        <input type="text"  value="{{$attribute['en']['product_name']}}" class="form-control" name="en[product_name]" required>
                                      </div>
                                      ...
                                      <div class="form-group form-group-default required ">
                                       ...
                                       <div class="form-group form-group-default required ">
                                        ...
                                        <input  value="{{$attribute['en']['product_meta_tag_title']}}" type="text" class="form-control" name="en[product_meta_tag_title]" required>
                                      </div>
                                      <div class="form-group form-group-default required ">
                                       ...
                                       <div class="form-group form-group-default required ">
                                        ...
                                        <input  value="{{$attribute['en']['product_meta_tag_keyword']}}" type="text" class="form-control" name="en[product_meta_tag_keyword]" required>
                                      </div>
                            ...
                            <div class="tab-pane " id="tab2arabic">
                              <div class="row column-seperation">
                                <div class="form-group form-group-default "  >
                                    ...
                                    <input   value="{{$attribute['ar']['product_name']}}" type="text" class="form-control" name="ar[product_name]" required>
                                  </div>
                                  ...
                                  <div class="form-group form-group-default ">
                                   ...
                                   <div class="form-group form-group-default ">
                                    ...
                                    <input  value="{{$attribute['ar']['product_meta_tag_title']}}" type="text" class="form-control" name="ar[product_meta_tag_title]" required>
                                  </div>
                                  <div class="form-group form-group-default ">
                                   ...
                                   <div class="form-group form-group-default ">
                                    ...
                                    <input  value="{{$attribute['ar']['product_meta_tag_keyword']}}" type="text" class="form-control" name="ar[product_meta_tag_keyword]" required>
                                  </div>
                ...
                <div class="row column-seperation">
                    <div class="form-group form-group-default required ">
                      ...
                      <div class="form-group form-group-default required ">
                        ...
                        <input type="text" class="form-control" name="prodduct_price" value="{{$products->prodduct_price}}" >
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required ">
                            ...
                            <input type="text" class="form-control" name="product_weight_value" required value="{{$products->product_weight_value}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          ...
                          <select class="form-control" data-init-plugin="select2" name="product_weight_type">
                            ...
                            <option @if($products->product_weight_type == 'gram')  selected @endif value="gram">Gram</option>
                            <option  @if($products->product_weight_type == 'Pound')  selected @endif  value="Pound">Pound</option>
                            <option  @if($products->product_weight_type == 'Once')  selected @endif  value="Once">Once</option>
                            <option  @if($products->product_weight_type == 'Pieces')  selected @endif  value="Pieces">Pieces</option>
                            <option  @if($products->product_weight_type == 'Packs')  selected @endif  value="Packs">Packs</option>
                            
                            <option  @if($products->product_weight_type == 'Litre')  selected @endif  value="Litre">Litre</option>
                  ...
                  <div class="row">
                       <div class="col-lg-4">
                          ...
                          <select class="form-control" data-init-plugin="select2" name="product_status">
                            <option value="">{{  __('product.out_of_stock')}}</option>
                              <option @if($products->product_status == 'in_stock')  selected @endif value="in_stock">In Stock</option>
                              <option @if($products->product_status == 'out_of_stock') selected @endif value="out_of_stock">Out Of Stock</option>
                      ...
                      <div class="col-lg-4">
                        <div class="input-group p-l-0">
                          <input type="text" class="form-control" value="{{$products->product_date}}"  id="datepicker-component" name="date_available">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select class="form-control" data-init-plugin="select2" name="status">
                          <option  @if($products->product_status == 1) selected @endif  value="1">Enable</option>
                            <option  @if($products->product_status == 2) selected @endif  value="2">Disable</option>
